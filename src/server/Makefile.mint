...
SERVER_CSRCS = \
	boot.c srv_debug.c is_of_type.c main.c rlist.c srv.c srv_appl.c \
        srv_appl_info.c srv_event.c srv_get.c srv_global.c srv_menu.c \
        srv_misc.c srv_queue.c srv_wind.c
