...
/****************************************************************************/
{
	...
	apb->int_out[0] = Graf_do_rubberbox(appl_info.vid,
										appl_info.eventpipe,apb->int_in[0],
...
/****************************************************************************/
{
	...
	apb->int_out[0] = Graf_do_dragbox(appl_info.vid,
										appl_info.eventpipe,apb->int_in[0],
										apb->int_in[1],apb->int_in[2],apb->int_in[3],
...
/****************************************************************************/
{
	...
	apb->int_out[0] = Graf_do_grmobox(appl_info.vid,
																		(RECT *)&apb->int_in[0],
																		(RECT *)&apb->int_in[4]);
...
void Graf_mouse(AES_PB *apb) {
	...
	apb->int_out[0] = Graf_do_mouse(appl_info.vid,apb->int_in[0],(MFORM *)apb->addr_in[0]);
}
