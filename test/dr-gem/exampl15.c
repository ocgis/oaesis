...
/*	rectangle list of a window as different filled bars.		*/
/*									*/
/************************************************************************/
...
#include "exampl15.h"				/* Resource file equates  */
...
BYTE	*wdw_title = "EXAMPLE15";
BYTE	*wdw_info  = "GEM VDI calls show window rectangle list";	
...

{
	...
	if (!rsrc_load(ADDR("EXAMPL15.RSC")))
	{
